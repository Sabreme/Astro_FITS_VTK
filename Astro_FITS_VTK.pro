...
LIBS += -framework Cocoa -framework CoreServices -framework ApplicationServices -framework OpenGL

LIBS += -L/usr/local/vtk/lib \
-lvtkChartsCore-6.3 \
-lvtkCommonColor-6.3 \
...
INCLUDEPATH += /usr/local/vtk/include/vtk-6.3
