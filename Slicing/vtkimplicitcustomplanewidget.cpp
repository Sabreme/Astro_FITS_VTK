...
vtkStandardNewMacro(vtkImplicitCustomPlaneWidget);

//vtkCxxSetObjectMacro(vtkImplicitCustomPlaneWidget,PlaneProperty,vtkProperty);



vtkImplicitCustomPlaneWidget::vtkImplicitCustomPlaneWidget() : vtkPolyDataSourceWidget()
{
    this->DiagonalRatio = 0.3;
      this->State = vtkImplicitCustomPlaneWidget::Start;
      this->EventCallbackCommand->SetCallback(vtkImplicitCustomPlaneWidget::ProcessEvents);
    ...
    //----------------------------------------------------------------------------
    vtkImplicitCustomPlaneWidget::~vtkImplicitCustomPlaneWidget()
    {
      this->Plane->Delete();
      this->Box->Delete();
      this->Outline->Delete();
    ...
    //----------------------------------------------------------------------------
    void vtkImplicitCustomPlaneWidget::SetEnabled(int enabling)
    {
      if ( ! this->Interactor )
        {
    ...
    //----------------------------------------------------------------------------
    void vtkImplicitCustomPlaneWidget::ProcessEvents(vtkObject* vtkNotUsed(object),
                                               unsigned long event,
                                               void* clientdata,
                                               void* vtkNotUsed(calldata))
    {
      vtkImplicitCustomPlaneWidget* self =
        reinterpret_cast<vtkImplicitCustomPlaneWidget *>( clientdata );
    ...
    //----------------------------------------------------------------------------
    void vtkImplicitCustomPlaneWidget::PrintSelf(ostream& os, vtkIndent indent)
    {
    ...
    //----------------------------------------------------------------------------
    void vtkImplicitCustomPlaneWidget::HighlightNormal(int highlight)
    {
      if ( highlight )
        {
    ...
    //----------------------------------------------------------------------------
    void vtkImplicitCustomPlaneWidget::HighlightPlane(int highlight)
    {
      if ( highlight )
        {
    ...
    //----------------------------------------------------------------------------
    void vtkImplicitCustomPlaneWidget::HighlightOutline(int highlight)
    {
      if ( highlight )
        {
    ...
    //----------------------------------------------------------------------------
    void vtkImplicitCustomPlaneWidget::OnLeftButtonDown()
    {
    ...
    //----------------------------------------------------------------------------
    void vtkImplicitCustomPlaneWidget::OnLeftButtonUp()
    {
    ...
    void vtkImplicitCustomPlaneWidget::OnMiddleButtonDown()
    {
      if ( this->ScaleEnabled )
        {
        this->State = vtkImplicitCustomPlaneWidget::Scaling;
    ...
    //----------------------------------------------------------------------------
    void vtkImplicitCustomPlaneWidget::OnMouseMove()
    {
      ...
      // Process the motion
      if ( this->State == vtkImplicitCustomPlaneWidget::MovingPlane )
        {
        this->TranslatePlane(prevPickPoint, pickPoint);
        }
      else if ( this->State == vtkImplicitCustomPlaneWidget::MovingOutline )
        {
        this->TranslateOutline(prevPickPoint, pickPoint);
        }
      else if ( this->State == vtkImplicitCustomPlaneWidget::MovingOrigin )
        {
        this->TranslateOrigin(prevPickPoint, pickPoint);
        }
      else if ( this->State == vtkImplicitCustomPlaneWidget::Pushing )
        {
        this->Push(prevPickPoint, pickPoint);
        }
      else if ( this->State == vtkImplicitCustomPlaneWidget::Scaling )
        {
        this->Scale(prevPickPoint, pickPoint, X, Y);
        }
      else if ( this->State == vtkImplicitCustomPlaneWidget::Rotating )
        {
    ...
    //----------------------------------------------------------------------------
    void vtkImplicitCustomPlaneWidget::Rotate(int X, int Y, double *p1, double *p2, double *vpn)
    {
    ...
    void vtkImplicitCustomPlaneWidget::TranslatePlane(double *p1, double *p2)
    {
    ...
    //----------------------------------------------------------------------------
    // Loop through all points and translate them
    void vtkImplicitCustomPlaneWidget::TranslateOutline(double *p1, double *p2)
    {
      //Get the motion vector
      double v[3];
      v[0] = p2[0] - p1[0];
    ...
    //----------------------------------------------------------------------------
    // Loop through all points and translate them
    void vtkImplicitCustomPlaneWidget::TranslateOrigin(double *p1, double *p2)
    {
      //Get the motion vector
      double v[3];
      v[0] = p2[0] - p1[0];
    ...
    //----------------------------------------------------------------------------
    void vtkImplicitCustomPlaneWidget::Scale(double *p1, double *p2,
    ...
    //----------------------------------------------------------------------------
    void vtkImplicitCustomPlaneWidget::Push(double *p1, double *p2)
    {
      //Get the motion vector
      double v[3];
      v[0] = p2[0] - p1[0];
    ...
    //----------------------------------------------------------------------------
    void vtkImplicitCustomPlaneWidget::CreateDefaultProperties()
    {
      // Normal properties
    ...
    //----------------------------------------------------------------------------
    void vtkImplicitCustomPlaneWidget::PlaceWidget(double bds[6])
    {
      int i;
    ...
    void vtkImplicitCustomPlaneWidget::SetOrigin(double x, double y, double z)
    {
      double origin[3];
      origin[0] = x;
      origin[1] = y;
    ...
    // Description:
    // Set the origin of the plane.
    void vtkImplicitCustomPlaneWidget::SetOrigin(double x[3])
    {
    ...
    double* vtkImplicitCustomPlaneWidget::GetOrigin()
    {
      return this->Plane->GetOrigin();
    }

    //----------------------------------------------------------------------------
    void vtkImplicitCustomPlaneWidget::GetOrigin(double xyz[3])
    {
    ...
    void vtkImplicitCustomPlaneWidget::SetNormal(double x, double y, double z)
    {
      double n[3];
      n[0] = x;
      n[1] = y;
    ...
    // Description:
    // Set the normal to the plane.
    void vtkImplicitCustomPlaneWidget::SetNormal(double n[3])
    {
    ...
    double* vtkImplicitCustomPlaneWidget::GetNormal()
    {
      return this->Plane->GetNormal();
    }

    //----------------------------------------------------------------------------
    void vtkImplicitCustomPlaneWidget::GetNormal(double xyz[3])
    {
      this->Plane->GetNormal(xyz);
    }

    //----------------------------------------------------------------------------
    void vtkImplicitCustomPlaneWidget::SetDrawPlane(int drawPlane)
    {
    ...
    //----------------------------------------------------------------------------
    void vtkImplicitCustomPlaneWidget::SetNormalToXAxis (int var)
    {
    ...
    //----------------------------------------------------------------------------
    void vtkImplicitCustomPlaneWidget::SetNormalToYAxis (int var)
    {
    ...
    //----------------------------------------------------------------------------
    void vtkImplicitCustomPlaneWidget::SetNormalToZAxis (int var)
    {
    ...
    //----------------------------------------------------------------------------
    void vtkImplicitCustomPlaneWidget::GetPolyData(vtkPolyData *pd)
    {
      pd->ShallowCopy(this->Cutter->GetOutput());
    }

    //----------------------------------------------------------------------------
    vtkPolyDataAlgorithm *vtkImplicitCustomPlaneWidget::GetPolyDataAlgorithm()
    {
      return this->Cutter;
    }

    //----------------------------------------------------------------------------
    void vtkImplicitCustomPlaneWidget::GetPlane(vtkPlane *plane)
    {
      if ( plane == NULL )
        {
        return;
    ...
    //----------------------------------------------------------------------------
    void vtkImplicitCustomPlaneWidget::UpdatePlacement()
    {
      this->Outline->Update();
      this->Cutter->Update();
      this->Edges->Update();
    ...
    //----------------------------------------------------------------------------
    void vtkImplicitCustomPlaneWidget::UpdateRepresentation()
    {
      if ( ! this->CurrentRenderer )
        {
        return;
    ...
    //----------------------------------------------------------------------------
    void vtkImplicitCustomPlaneWidget::SizeHandles()
    {
    ...
    void vtkImplicitCustomPlaneWidget::finger2Pressed(int X, int Y)
    {
        // Okay, we can process this. See if we've picked anything.
        // Make sure it's in the activated renderer
        if (!this->CurrentRenderer || !this->CurrentRenderer->IsInViewport(X, Y))
    ...
    void vtkImplicitCustomPlaneWidget::finger2Moving(int X, int Y, int X_last, int Y_last)
    {
        this->HighlightPlane(1);
