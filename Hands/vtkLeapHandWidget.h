...
=========================================================================*/
// .NAME vtkLeapHandWidget - 2D widget for manipulating a marker prop
// .SECTION Description
...
#ifndef __vtkLeapHandWidget_h
#define __vtkLeapHandWidget_h
...
class vtkPolyData;
class vtkProp;
class vtkLeapHandWidgetObserver;
class vtkRenderer;

class VTK_EXPORT vtkLeapHandWidget : public vtkInteractorObserver
{
public:
  static vtkLeapHandWidget* New();
  vtkTypeMacro(vtkLeapHandWidget, vtkInteractorObserver);
...
protected:
  ...
  vtkLeapHandWidgetObserver *Observer;
...
private:
  vtkLeapHandWidget(const vtkLeapHandWidget&);  // Not implemented
  void operator=(const vtkLeapHandWidget&);  // Not implemented
};
